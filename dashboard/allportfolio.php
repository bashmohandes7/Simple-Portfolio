              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?= $pro['name']?></td>
                    <td><img height="200px" src="upload/<?= $pro['img']?>"/></td>
                    <td><a href="updateportfolio.php?proid=<?= $pro['id']?>" class="btn btn-block btn-info" target="_blank">Update</a></td>
                    <td><a href="deleteportfolio.php?proid=<?= $pro['id']?>" class="btn btn-block btn-danger">Delete</a></td>
                  </tr>
                  <?php endforeach; ?>
                  </tbody>
                  <tfoot>
